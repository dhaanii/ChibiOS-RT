...
//There is no APB1 bus to sync to --Tony B
 ...
 * @notapi
 */
//Many defines for STM32_RTCCLK == 0, but many linked to other
//defines. I'm going to leave this alone for now. Redefining as 0 
//is an option.
